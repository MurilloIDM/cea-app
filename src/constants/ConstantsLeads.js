const TITLE_SUCESS_SAVE_LEAD = "Inscrição realizada com sucesso!";
const MESSAGE_SUCCESS_SAVE_LEAD = "Assim que as vagas forem abertas, vamos te avisar!";
...
const ERROR_GENERIC_DEVICE_ID_MESSAGE = "Ocorreu um erro inesperado, tente mais tarde!";
